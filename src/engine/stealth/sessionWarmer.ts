...
import { ScrollingEngine } from './scrollingEngine';
...
export class SessionWarmer {
   ...
   */
  static async warmSession(context: BrowserContext, mousePos: { x: number; y: number }) {
    ...
    for (const site of selected) {
      ...
      try {
        ...
        await ScrollingEngine.humanScroll(page, 300 + Math.random() * 200);
